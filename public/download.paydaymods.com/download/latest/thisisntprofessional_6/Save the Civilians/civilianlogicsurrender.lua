--v1.0: fixed this function (formerly an override, not a posthook) preventing no mercy's mission scripts from pacifying civilians with the fake sentries objective 
