...
function LocalizationManager:text(string_id, ...)
	...
	or string_id == "bm_wp_baka_b_midsupp_desc" and "A ##medium-sized## suppressor for the Micro Uzi.\nReduces the weapon's sound radius to ##6 meters.\n20% shorter## overall range.\n##7.5% slower## ADS speeds."
	...
	or string_id == "bm_wp_winchester_b_suppressed_desc" and "A ##medium-sized## suppressor.\n##30% shorter## overall range.\nReduces the weapon's sound radius to ##2 meters.\n7.5% slower## ADS speeds."
	...
	or string_id == "bm_wp_upg_ns_ass_smg_medium_desc" and "A ##medium-sized## suppressor.\nReduces the weapon's sound radius to ##6 meters.\n30% shorter## overall range.\n##5% slower## ADS speeds."
	...
	or string_id == "bm_wp_upg_ns_pis_medium_desc" and "A ##medium-sized## suppressor.\n##30% shorter## overall range.\nReduces the weapon's sound radius to ##6 meters.\n5% slower## ADS speeds."
	--Monolith 
	...
	or string_id == "bm_wp_upg_ns_pis_medium_slim_desc" and "A ##medium-sized## suppressor.\nReduces the weapon's sound radius to ##6 meters.\n30% shorter## overall range.\n##5% slower## ADS speeds."
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_ns_medium_gem" and "GemTech Blackside Suppressor"
	or string_id == "bm_wp_upg_ns_medium_gem_desc" and "A ##medium-sized## suppressor.\nReduces the weapon's sound radius to ##6 meters.\n30% shorter## overall range.\n##5% slower## ADS speeds."
	...
	or string_id == "bm_wp_upg_ns_shot_thick_desc" and "A ##medium-sized## suppressor.\nReduces the weapon's sound radius to ##6 meters.\n20% shorter## overall range.\n##5% slower## ADS speeds."
	...
	or string_id == "bm_wp_upg_o_acog_desc" and "4x zoom scope.\n##5% slower## ADS."
	--Milspec
	or DMCWO._data.reelnames == true and string_id == "bm_wp_upg_o_specter" and "ELCAN Specter DR 1-4x Scope"
	or string_id == "bm_wp_upg_o_specter_desc" and "4x zoom scope.\n##5% slower## ADS."
	--See More
	...
	or string_id == "bm_wp_upg_o_leupold_desc" and "8x zoom scope that ##auto-marks## enemies ##in stealth## or ##specials.##\n##10% slower## ADS."
	--45 irons
	...
	or string_id == "shortdot_normal_desc" and "6x zoom scope.\n##7.5% slower## ADS speeds."
	...
	--Hein
	or string_id == "bm_melee_hien_desc" and "A long katana entrusted to Ikaruga by her adoptive father.\n\nShe is one of the 5 Hanzo academy girls training to become shinobi."
	...
	or string_id == "bm_w_grach_desc" and "A Russian handgun chambered in 9x19mm.\nCan pierce thin walls."
	...
	or string_id == "bm_wp_wpn_fps_pis_grach_sil_desc" and "A ##medium-sized## suppressor.\n##30% shorter## overall range.\nReduces the weapon's sound radius to ##6 meters.\n5% slower## ADS speeds."
	
	--[[FIVE SEVEN]]
	or DMCWO._data.reelnames == true and string_id == "bm_w_fs" and "FN Five-seveN"
	or string_id == "bm_w_fs_desc" and "A Belgian handgun chambered in 5.7×28mm.\nCan pierce enemies and walls."
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_pis_fs_comp" and "Bushing Compensator"
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_pis_fs_sil" and "SureFire MINI-MONSTER Suppressor"
	or string_id == "bm_wp_wpn_fps_pis_fs_sil_desc" and "A ##medium-sized## suppressor.\n##30% shorter## overall range.\nReduces the weapon's sound radius to ##6 meters.\n5% slower## ADS speeds."
	or string_id == "bm_wp_wpn_fps_pis_fs_smallsil" and "Medium-Sized Suppressor"
	or string_id == "bm_wp_wpn_fps_pis_fs_smallsil_desc" and "A ##medium-sized## suppressor.\n##30% shorter## overall range.\nReduces the weapon's sound radius to ##6 meters.\n5% slower## ADS speeds."
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_pis_fs_m_extended" and "30rnd Five-seveN Magazine"
	or string_id == "bm_wp_wpn_fps_pis_fs_m_extended_desc" and "##10% slower## reload speeds."
	...
	or string_id == "bm_wp_wpn_fps_pis_qs_sil_desc" and "A ##medium-sized## suppressor.\n##30% shorter## overall range.\nReduces the weapon's sound radius to ##6 meters.\n5% slower## ADS speeds."
	...
	or DMCWO._data.reelnames == true and string_id == "bm_wp_wpn_fps_upg_l115_body_green" and "Olive Drab Body"
