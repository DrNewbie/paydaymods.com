...
function NewRaycastWeaponBase:_update_stats_values()
	...
	self._bolt_time = self:weapon_tweak_data().bolt_time or nil
	self._bolt_time_unscope = self:weapon_tweak_data().bolt_time_unscope or nil
	self._bolt_time_reload = self:weapon_tweak_data().bolt_time_reload or nil
	self._bolt_time_ads_anim = self:weapon_tweak_data().bolt_time_ads_anim or nil
...
function NewRaycastWeaponBase:fire_rate_multiplier()
	...
	if self._fire_rate_init_count and (self._fire_rate_init_count > self._shotsfired) and self:fire_mode() ~= "single" and not self:in_burst_mode() then
	--log("DICSK")
