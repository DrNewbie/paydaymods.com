...
Hooks:PostHook( PlayerTweakData, "init", "CustomWeaponsInit", function(self)
	...
	if self.stances.tt then	
		self.stances.tt.standard.shoulders.translation = self.stances.ppk.standard.shoulders.translation 
		self.stances.tt.standard.shoulders.rotation = self.stances.ppk.standard.shoulders.rotation
		
		self.stances.tt.crouched.shoulders.translation = self.stances.ppk.crouched.shoulders.translation
		self.stances.tt.crouched.shoulders.rotation = self.stances.ppk.crouched.shoulders.rotation
	end
