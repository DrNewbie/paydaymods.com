--REBALANCE OPTION 2
if not SGO or SGO.settings.use_tweako ~= 2 then return end
...
self.contraband.stats.damage = 53
...
self.basset.stats_modifiers = {damage = 4}
--self.basset.stats.concealment = 0
self.basset.AMMO_MAX = 36
self.basset.stats.damage = 30
self.basset.stats.spread = 0
self.basset.stats.recoil = 32
--self.basset.fire_mode_data.fire_rate = 0.4
self.basset.AMMO_PICKUP = {10,12}
--self.basset.armor_piercing_chance = 1
--self.basset.can_shoot_through_enemy = true
self.basset.rays = 8
self.basset.stats.reload = 14
self.basset.damage_near = 100
self.basset.damage_far = 1500

self.x_basset.stats_modifiers = {damage = 4}
--self.x_basset.stats.concealment = 0
self.x_basset.AMMO_MAX = 48
self.x_basset.stats.damage = 30
self.x_basset.stats.spread = 0
self.x_basset.stats.recoil = 32
--self.x_basset.fire_mode_data.fire_rate = 0.4
self.x_basset.AMMO_PICKUP = {10,12}
--self.x_basset.armor_piercing_chance = 1
--self.x_basset.can_shoot_through_enemy = true
self.x_basset.rays = 8
self.x_basset.stats.reload = 14
self.x_basset.damage_near = 100
self.x_basset.damage_far = 1500

self.boot.stats_modifiers = {damage = 5}
--self.boot.stats.concealment = 0
self.boot.CLIP_AMMO_MAX = 6
self.boot.AMMO_MAX = 24
self.boot.stats.damage = 68
...
self.chinchilla.stats.damage = 62
...
self.new_raging_bull.stats.damage = 62
...
--self.breech.stats.concealment = 0
self.breech.AMMO_MAX = 24
self.breech.stats.damage = 180
self.breech.stats.recoil = 32
self.breech.stats.spread = 32
self.breech.can_shoot_through_enemy = true
self.breech.armor_piercing_chance = 1
self.breech.AMMO_PICKUP = {15, 20}
...
--self.shrew.stats.concealment = 0
self.shrew.AMMO_MAX = 90
self.shrew.stats.damage = 90
self.shrew.stats.recoil = 32
self.shrew.stats.spread = 32
self.shrew.can_shoot_through_enemy = true
self.shrew.armor_piercing_chance = 1
self.shrew.AMMO_PICKUP = {15, 20}
self.shrew.fire_mode_data.fire_rate = 0.1
self.shrew.can_shoot_through_shield = false
self.shrew.stats.reload = 20
...
self.glock_18c.stats.damage = 80
...
self.colt_1911.stats.damage = 90
...
self.flamethrower_mk2.stats.damage = 60
...
self.siltstone.stats.damage = 10
...
self.desertfox.stats.damage = 15
...
self.winchester1874.stats.damage = 15
...
self.x_packrat.stats.damage = 90
...
--self.x_shrew.stats.concealment = 0
self.x_shrew.stats.damage = 90
self.x_shrew.stats.recoil = 34
self.x_shrew.stats.spread = 32
self.x_shrew.AMMO_MAX = 100
self.x_shrew.AMMO_PICKUP = {20, 25}
self.x_shrew.fire_mode_data.fire_rate = 0.1
self.x_shrew.armor_piercing_chance = 1
self.x_shrew.can_shoot_through_enemy = true
self.x_shrew.can_shoot_through_shield = false
self.x_shrew.stats.reload = 50

--self.x_g17.stats.concealment = 0
self.x_g17.stats.damage = 80
...
self.x_chinchilla.stats_modifiers = {damage = 5}
self.x_chinchilla.CLIP_AMMO_MAX = 12
self.x_chinchilla.AMMO_MAX = 36
self.x_chinchilla.stats.damage = 50
...
--]]
	...
	then
	self.m27gear.stats_modifiers = {damage = 2}
	--self.scar_m203.stats.concealment = 0
	self.m27gear.CLIP_AMMO_MAX = 30
	self.m27gear.AMMO_MAX = 120
	self.m27gear.stats.damage = 60
	self.m27gear.damage_rebalance = 60
	...
	if SystemFS:exists("assets/mod_overrides/PLA Arms Pack - QBZ-95 AR/main.xml")
	then
	self.qbz95.stats_modifiers = {damage = 2}
	--self.scar_m203.stats.concealment = 0
	self.qbz95.CLIP_AMMO_MAX = 30
	self.qbz95.AMMO_MAX = 120
	self.qbz95.stats.damage = 60
	self.qbz95.damage_rebalance = 60
	...
	if SystemFS:exists("assets/mod_overrides/PLA Arms Pack - QBZ-03 AR/main.xml")
	then
	self.qbz3.stats_modifiers = {damage = 2}
	--self.scar_m203.stats.concealment = 0
	self.qbz3.CLIP_AMMO_MAX = 30
	self.qbz3.AMMO_MAX = 120
	self.qbz3.stats.damage = 60
	self.qbz3.damage_rebalance = 60
	self.qbz3.stats.spread = 32
	self.qbz3.stats.recoil = 32
	self.qbz3.armor_piercing_chance = 1
	self.qbz3.can_shoot_through_enemy = true
	self.qbz3.can_shoot_through_shield = false
	self.qbz3.AMMO_PICKUP = {20,30}
	self.qbz3.stats.reload = 30
	else
	end
	...
	self.scar_m203.stats.damage = 60
	...
	self.ots_14_4a.stats.damage = 45
	...
	self.stealthy.AMMO_MAX = 90
	self.stealthy.stats.damage = 80
	...
	--Shotguns
	if SystemFS:exists("assets/mod_overrides/KS-23/main.xml")
	then
	self.ks23.stats_modifiers = {damage = 10}
	self.ks23.AMMO_MAX = 9
	self.ks23.stats.damage = 200
	self.ks23.stats.spread = 1
	self.ks23.AMMO_PICKUP = {10,15}
	self.ks23.can_shoot_through_enemy = true
	self.ks23.stats.reload = 15
	self.ks23.damage_near = 100
	...
	if SystemFS:exists("assets/mod_overrides/Vepr-12/main.xml")
	then
	self.vepr12.stats_modifiers = {damage = 2}
	self.vepr12.AMMO_MAX = 20
	self.vepr12.stats.damage = 125
	self.vepr12.stats.spread = 1
	self.vepr12.AMMO_PICKUP = {10,15}
	--self.vepr12.can_shoot_through_enemy = true
	self.vepr12.stats.reload = 15
	self.vepr12.damage_near = 100
	self.vepr12.damage_far = 1500
	else
	end
...
--Sniper Rifles
	...
	self.winchester1894.stats.damage = 15
	...
	self.Nitro.stats_modifiers = {damage = 70}	
    self.Nitro.AMMO_PICKUP = {5, 6}
	self.Nitro.stats.damage = 20
	...
	if SystemFS:exists("assets/mod_overrides/PLA Arms Pack - FY-JS Sniper/main.xml")
	then
	self.fyjs.stats_modifiers = {damage = 100}
	self.fyjs.CLIP_AMMO_MAX = 5
	self.fyjs.AMMO_MAX = 40
	self.fyjs.stats.damage = 15
	...
	if SystemFS:exists("assets/mod_overrides/PLA Arms Pack - QBU-88 Sniper/main.xml")
	then
	self.qbu88.stats_modifiers = {damage = 100}
	self.qbu88.CLIP_AMMO_MAX = 20
	self.qbu88.AMMO_MAX = 40
	self.qbu88.stats.damage = 9
	...
	self.svudragunov.stats.damage = 15
	...
	self.unibarrett.stats.damage = 50
...
--Pistols
	if SystemFS:exists("assets/mod_overrides/AJM-9/main.xml")
	then
	self.ajm.AMMO_MAX = 90
	self.ajm.stats.damage = 85
	self.ajm.stats.recoil = 32
	self.ajm.stats.spread = 20
	self.ajm.can_shoot_through_enemy = true
	self.ajm.armor_piercing_chance = 1
	self.ajm.AMMO_PICKUP = {20,30}
	--self.ajm.fire_mode_data.fire_rate = 0.05
	self.ajm.can_shoot_through_shield = false
	self.ajm.stats.reload = 20
	self.ajm.kick = self.ajm.kick or {}
	self.ajm.kick.standing = {
		0,
		0,
		0,
		0
	}
	self.ajm.kick.crouching = self.ajm.kick.standing
	self.ajm.kick.steelsight = self.ajm.kick.standing
	else
	end
	if SystemFS:exists("assets/mod_overrides/Duke 1911/main.xml")
	then
	--self.duke1911.stats.concealment = 0
	self.duke1911.AMMO_MAX = 90
	self.duke1911.stats.damage = 160
	self.duke1911.stats.recoil = 32
	self.duke1911.stats.spread = 32
	self.duke1911.can_shoot_through_enemy = true
	self.duke1911.can_shoot_through_shield = false
	self.duke1911.armor_piercing_chance = 1
	self.duke1911.AMMO_PICKUP = {15, 20}
	self.duke1911.fire_mode_data.fire_rate = 0.1
	self.duke1911.stats.reload = 20
	else
	end
	...
	then
	--self.pm.stats.concealment = 0
	self.pm.AMMO_MAX = 150
	self.pm.stats.damage = 80
	...
	if SystemFS:exists("assets/mod_overrides/Walther P99/main.xml")
	then
	--self.p99.stats.concealment = 0
	self.p99.AMMO_MAX = 150
	self.p99.stats.damage = 80
	self.p99.stats.recoil = 32
	self.p99.stats.spread = 32
	self.p99.can_shoot_through_enemy = true
	self.p99.can_shoot_through_shield = false
	self.p99.armor_piercing_chance = 1
	self.p99.AMMO_PICKUP = {15, 20}
	self.p99.fire_mode_data.fire_rate = 0.1
	self.p99.stats.reload = 20
	else
	end
	if SystemFS:exists("assets/mod_overrides/Blizzard 443 Pistol/main.xml")
	then
	self.grach.AMMO_MAX = 60
	self.grach.stats.damage = 90
...
--SMGs
	if SystemFS:exists("assets/mod_overrides/HL MP7 AutoPistol/main.xml")
	then
	--self.hlmp7.stats.concealment = 0
	self.hlmp7.AMMO_MAX = 180
	self.hlmp7.stats.damage = 75
	self.hlmp7.damage_rebalance = 60
	self.hlmp7.stats.recoil = 32
	self.hlmp7.stats.spread = 20
	self.hlmp7.AMMO_PICKUP = {30, 35}
	self.hlmp7.armor_piercing_chance = 1
	--self.hlmp7.can_shoot_through_enemy = true
	self.hlmp7.can_shoot_through_shield = false
	self.hlmp7.stats.reload = 50
	self.hlmp7.kick = self.hlmp7.kick or {}
	self.hlmp7.kick.standing = {
		0,
		0,
		0,
		0
	}
	self.hlmp7.kick.crouching = self.hlmp7.kick.standing
	self.hlmp7.kick.steelsight = self.hlmp7.kick.standing
	else
	end
	if SystemFS:exists("assets/mod_overrides/MP40/main.xml")
	then
	--self.mp40.stats.concealment = 0
	self.mp40.AMMO_MAX = 180
	self.mp40.stats.damage = 75
	self.mp40.damage_rebalance = 60
	self.mp40.stats.recoil = 32
	self.mp40.stats.spread = 20
	self.mp40.AMMO_PICKUP = {30, 35}
	self.mp40.armor_piercing_chance = 1
	--self.mp40.can_shoot_through_enemy = true
	self.mp40.can_shoot_through_shield = false
	self.mp40.stats.reload = 50
	self.mp40.kick = self.mp40.kick or {}
	self.mp40.kick.standing = {
		0,
		0,
		0,
		0
	}
	self.mp40.kick.crouching = self.mp40.kick.standing
	self.mp40.kick.steelsight = self.mp40.kick.standing
	else
	end
	...
	--self.k1a7.stats.concealment = 0
	self.k1a7.CLIP_AMMO_MAX = 30
	self.k1a7.AMMO_MAX = 120
	self.k1a7.stats.damage = 60
	...
	self.spectre_m4.stats.damage = 85
...
--LMGs
	...
	if SystemFS:exists("assets/mod_overrides/LSAT/main.xml")
	then
	self.lsat.AMMO_MAX = 400
	self.lsat.CLIP_AMMO_MAX = 200
	self.lsat.stats.damage = 130
	self.lsat.stats.recoil = 32
	self.lsat.stats.spread = 16
	self.lsat.AMMO_PICKUP = {30,40}
	self.lsat.armor_piercing_chance = 1
	self.lsat.can_shoot_through_shield = true
	self.lsat.can_shoot_through_enemy = true
	self.lsat.can_shoot_through_wall = true
	self.lsat.stats.reload = 30
	else
	end
	...
	self.pecheneg.stats.damage = 130
...
--Magnums
	...
	self.peacekeeper.stats.damage = 50
	...
	self.shatters_fury.stats.damage = 50
...
--Akimbo Pistols
	if SystemFS:exists("assets/mod_overrides/KRISS KARD/main.xml")
	then
	self.x_kard.AMMO_MAX = 180
	self.x_kard.stats.damage = 85
	self.x_kard.stats.recoil = 32
	--self.x_kard.stats.spread = 32
	self.x_kard.can_shoot_through_enemy = true
	self.x_kard.armor_piercing_chance = 1
	self.x_kard.AMMO_PICKUP = {20,30}
	--self.x_kard.fire_mode_data.fire_rate = 0.05
	self.x_kard.can_shoot_through_shield = false
	self.x_kard.stats.reload = 20
	self.x_kard.kick = self.x_kard.kick or {}
	self.x_kard.kick.standing = {
		0,
		0,
		0,
		0
	}
	self.x_kard.kick.crouching = self.x_kard.kick.standing
	self.x_kard.kick.steelsight = self.x_kard.kick.standing
	else
	end
	if SystemFS:exists("assets/mod_overrides/Makarov/main.xml")
	then
	--self.x_pm.stats.concealment = 0
	self.x_pm.AMMO_MAX = 150
	self.x_pm.stats.damage = 80
	self.x_pm.stats.recoil = 32
	self.x_pm.stats.spread = 32
	self.x_pm.can_shoot_through_enemy = true
	self.x_pm.can_shoot_through_shield = false
	self.x_pm.armor_piercing_chance = 1
	self.x_pm.AMMO_PICKUP = {15, 20}
	self.x_pm.fire_mode_data.fire_rate = 0.1
	self.x_pm.stats.reload = 20
	else
	end
	if SystemFS:exists("assets/mod_overrides/AJM-9/main.xml")
	then
	self.x_ajm.AMMO_MAX = 180
	self.x_ajm.stats.damage = 85
	self.x_ajm.stats.recoil = 32
	--self.x_ajm.stats.spread = 32
	self.x_ajm.can_shoot_through_enemy = true
	self.x_ajm.armor_piercing_chance = 1
	self.x_ajm.AMMO_PICKUP = {20,30}
	--self.x_ajm.fire_mode_data.fire_rate = 0.05
	self.x_ajm.can_shoot_through_shield = false
	self.x_ajm.stats.reload = 20
	self.x_ajm.kick = self.x_ajm.kick or {}
	self.x_ajm.kick.standing = {
		0,
		0,
		0,
		0
	}
	self.x_ajm.kick.crouching = self.x_ajm.kick.standing
	self.x_ajm.kick.steelsight = self.x_ajm.kick.standing
	else
	end
	if SystemFS:exists("assets/mod_overrides/More Akimbo Pistols")
	then 
	self.x_beagle.AMMO_MAX = 120
	self.x_beagle.stats.damage = 90
...
--Akimbo SMGs
	if SystemFS:exists("assets/mod_overrides/Minebea PM-9/main.xml")
	then
	--self.x_minebea.stats.concealment = 0
	self.x_minebea.AMMO_MAX = 240
	self.x_minebea.stats.damage = 75
	self.x_minebea.stats.recoil = 32
	self.x_minebea.stats.spread = 20
	self.x_minebea.AMMO_PICKUP = {30, 35}
	self.x_minebea.armor_piercing_chance = 1
	--self.x_minebea.can_shoot_through_enemy = true
	self.x_minebea.can_shoot_through_shield = false
	self.x_minebea.stats.reload = 50
	self.x_minebea.kick = self.x_minebea.kick or {}
	self.x_minebea.kick.standing = {
		0,
		0,
		0,
		0
	}
	self.x_minebea.kick.crouching = self.x_minebea.kick.standing
	self.x_minebea.kick.steelsight = self.x_minebea.kick.standing
	else
	end
	if SystemFS:exists("assets/mod_overrides/Spectre M4/main.xml")
	then
	...
	self.x_spectre_m4.stats.damage = 85
	...
	self.x_sidekick.stats.damage = 75
	...
	self.x_skorpion.stats.damage = 75
	...
	self.x_miniuzi.stats.damage = 75
...
--Akimbo Shotguns
	...
	self.x_huntsman.stats.damage = 68
...
--Akimbo ARs 
	...
	self.x_akm_gold.stats.damage = 160
